        ...
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
            <div class="card flex-fill">
                <div class="card-header p-4">
                    <span class="fs-2 fw-700">Data Kategori</span>
                    <a href="{{ route('kategori.create') }}" class="btn btn-primary float-end "><svg
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <form id="deleteFormKategori{{$kategori->id}}" method="POST" action="{{ route('kategori.destroy', $kategori->id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-sm btn-danger mx-1" onclick="confirmDeleteKategori({{$kategori->id}})" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="Hapus Data">
    ...
    <div class="row">
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
            <div class="card flex-fill">
                ...
                <div class="table-responsive px-3">
                    <table class="table table-bordered table-hover" style="width: 100%" id="dataTable2">
                        <thead>
                            <tr>
                                <th class="text-start d-none d-xl-table-cell">NO</th>
