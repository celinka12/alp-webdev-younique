        ...
        <form action="{{route('kategori.update',$kategori->id)}}" method="POST">
            ...
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_kategori" class="form-control mb-2" value="{{$kategori->nama_kategori}}"
                                        required>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex float-start">
                    <a href="{{route('kategori.index')}}" class="btn btn-danger me-3"><svg xmlns="http://www.w3.org/2000/svg" width="20"
