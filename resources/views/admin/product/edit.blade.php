                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="detail_kategori_id" id="detail_kategori" class="form-select">
                                        @foreach ($detailKategoris as $detailkategori)
                                            <option value="{{ $detailkategori->id }}"
                                                {{ $detailkategori->id == $product->detail_kategori_id ? 'selected' : '' }}>
                                                {{ $detailkategori->nama_detail_kategori }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="harga_product" class="form-control mb-2"
                                        value="{{ $product->harga_product }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="qty_product" class="form-control mb-2"
                                        value="{{ $product->qty_product }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <textarea name="deskripsi_product" class="form-control mb-2" id="" cols="30" rows="10" required>{{ $product->deskripsi_product }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <img src="{{asset('assets/images/product/'.$product->image_product)}}" style="width:200px" alt="Image Product" class="img-fluid mb-3">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="image_product" class="form-control mb-2">
                                </div>
                            </div>
                        </div>
